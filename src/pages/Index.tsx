          ...
          <div className="text-center">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center items-center space-x-8">
                <a 
                  href="https://github.com/yourusername/menu-magic" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group flex flex-col items-center space-y-1 text-muted-foreground hover:text-primary transition-colors duration-300"
                >
                  ...
                  <span className="text-xs text-muted-foreground/70">
                    {language === 'ru' ? 'Исходный код проекта' : 'Project Source Code'}
                  </span>
                </a>
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground/70">
                    {language === 'ru' ? 'Профессиональный профиль' : 'Professional Profile'}
                  </span>
                </a>
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground/70">
                    {language === 'ru' ? 'Прямая связь' : 'Direct Contact'}
                  </span>
                </a>
              </div>
            </div>
